        ...
        <nav class="navbar navbar-expand-lg p-0">
            ...
            <ul class="navbar-nav quick-links d-none d-lg-flex align-items-center">
                <li class="nav-item dropdown-hover d-none d-lg-block me-2">
                    <a class="nav-link"
                        href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-chat.html">Chat</a>
                </li>
                <li class="nav-item dropdown-hover d-none d-lg-block me-2">
                    <a class="nav-link"
                        href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-calendar.html">Calendar</a>
                </li>
                <li class="nav-item dropdown-hover d-none d-lg-block">
                    <a class="nav-link"
                        href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-email.html">Email</a>
                </li>
            </ul>
                                ...
                                <div class="message-body" data-simplebar>
                                    <a href="javascript:void(0)"
                                        ...
                                        <div class="w-100 ps-3">
                                            ...
                                            <span class="fs-2 d-block mt-1 text-muted">Congratulate
                                                him</span>
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        <div class="w-100 ps-3">
                                            ...
                                            <span class="fs-2 d-block mt-1 text-muted">Salma sent
                                                you new
                                                message</span>
                                        </div>
                                    </a>
                                    ...
                                    <div class="message-body">
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/page-user-profile.html"
                                            ...
                                            <div class="w-100 ps-3 ms-1">
                                                ...
                                                <span class="fs-3 d-block mt-1 text-muted">Account
                                                    Settings</span>
                                            </div>
                                        </a>
                                        ...
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-email.html"
                                            ...
                                            <div class="w-100 ps-3 ms-1">
                                                ...
                                                <span class="fs-3 d-block mt-1 text-muted">Messages
                                                    & Emails</span>
                                            </div>
                                        </a>
                                        ...
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-notes.html"
                                            ...
                                            <div class="w-100 ps-3 ms-1">
                                                ...
                                                <span class="fs-3 d-block mt-1 text-muted">To-do
                                                    and Daily
                                                    Tasks</span>
                                            </div>
                                        </a>
        ...
        <div class="offcanvas offcanvas-start dropdown-menu-nav-offcanvas" data-bs-scroll="true" tabindex="-1"
            ...
            <nav class="sidebar-nav scroll-sidebar">
                <div class="offcanvas-header justify-content-between">
                    <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/logos/favicon.png"
                            ...
                            <ul aria-expanded="false" class="collapse first-level my-3">
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            ...
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-chat.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-invoice.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-mobile.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-message-box.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-cart.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-date.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-lifebuoy.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <div
                                            class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                            <img src="https://bootstrapdemos.wrappixel.com/spike/dist/assets/images/svgs/icon-dd-application.svg"
                                                alt="spike-img" class="img-fluid" width="24" height="24" />
                                        </div>
                                        <div>
                                ...
                                <ul class="px-8 mt-6 mb-4">
                                    ...
                                    <li class="sidebar-item py-2">
                                        <a class="fw-semibold text-dark" href="javascript:void(0)">Authentication
                                            Design</a>
                                    </li>
                                    <li class="sidebar-item py-2">
                                    ...
                                    <li class="sidebar-item py-2">
                                        <a class="fw-semibold text-dark" href="javascript:void(0)">User
                                            Application</a>
                                    </li>
                                    <li class="sidebar-item py-2">
                                        <a class="fw-semibold text-dark" href="javascript:void(0)">Account
                                            Settings</a>
                                    </li>
                                </ul>
                            </ul>
        ...
        <nav class="navbar navbar-expand-xl container-fluid p-0">
            <ul class="navbar-nav">
                <li class="nav-item d-none d-xl-block">
                    <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/index.html"
                                ...
                                <div class="row gx-0">
                                    <div class="col-6">
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-invoice.html"
                                            ...
                                            <span class="d-block text-body-color fs-3">Get latest
                                                invoice</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-chat.html"
                                            ...
                                            <span class="d-block text-body-color fs-3">New
                                                messages</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-contact2.html"
                                            ...
                                            <span class="d-block text-body-color fs-3">2 Unsaved
                                                Contacts</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-email.html"
                                            ...
                                            <span class="d-block text-body-color fs-3">Get new
                                                emails</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/page-user-profile.html"
                                            ...
                                            <span class="d-block text-body-color fs-3">More
                                                information</span>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-calendar.html"
                                            ...
                                            <span class="d-block text-body-color fs-3">Get
                                                dates</span>
                                        </a>
                                    </div>
                                </div>
